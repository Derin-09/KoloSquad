...
//             className="h-2 rounded bg-[color:var(--accent)]"
//             style={{
//               width: `${Math.min(100, ((s.balance || 0) / Math.max(1, s.target_amount)) * 100)}%`
//             }}
//           />
//         </div>
...
//           <div className="flex items-center gap-2">
//             <a
//               href={`/flex?name=${encodeURIComponent(s.name)}&saved=${encodeURIComponent(s.balance)}&target=${encodeURIComponent(s.target_amount || 0)}`}
//               className="underline"
//             >
//               Flex card
//             </a>
