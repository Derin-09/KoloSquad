  ...
  if (variant === 'dropdown') {
    return (
      <div className="relative group">
        <button
          className={`
            p-2 rounded-md hover:bg-[color:var(--muted)] 
        ...
        ">
          <button
            ...
            className={`
              w-full px-3 py-2 text-left text-sm hover:bg-[color:var(--muted)] 
              flex items-center gap-2 transition-colors
              ${theme === 'light' ? 'text-[color:var(--accent)]' : ''}
            `}
          >
          ...
          <button
            ...
            className={`
              w-full px-3 py-2 text-left text-sm hover:bg-[color:var(--muted)] 
              flex items-center gap-2 transition-colors
              ${theme === 'dark' ? 'text-[color:var(--accent)]' : ''}
            `}
          >
          ...
          <button
            ...
            className={`
              w-full px-3 py-2 text-left text-sm hover:bg-[color:var(--muted)] 
              flex items-center gap-2 transition-colors
              ${theme === 'system' ? 'text-[color:var(--accent)]' : ''}
            `}
          >
