      ...
      >
        ...
        >
          ...
          <motion.div
            ...
            whileTap="tap"
          >
            <Link href="/sign-in" className="px-3 md:py-2 text-sm text-[color:var(--accent)] hover:text-[color:var(--accent)] md:transition-colors">
              Sign in
            </Link>
          </motion.div>
          <motion.div
          ...
          >
            <Link
              href="/sign-up"
              className="hidden md:block rounded-md bg-black text-white dark:bg-white dark:text-black px-3 py-2 text-sm hover:shadow-lg transition-shadow"
            >
              Create free account
            </Link>
          </motion.div>
